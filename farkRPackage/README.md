...
farkRPackage is an example R package [available on
GitHub](https://github.com/FrankThomasTveter/metfark/farkRPackage).
...
source code). The farkRPackage can also be installed from github
(although as an example package it does not contain anything useful):

``` r
# install.packages("devtools")
devtools::install_github("FrankThomasTveter/metfark/farkRPackage")
```
...
(`farkRPackage` is the project’s root folder):
...
`farkRPackage.Rproj` identifies the folder as an R package project.
...
``` r
library(farkRPackage)  # Activate package in current R session
...
For farkRPackage, you will find all the raw data as .csv files in the
[`data-raw/`](https://github.com/FrankThomasTveter/metfark/farkRPackage/tree/master/data-raw)
...
#' }
#' @source \url{https://www.github.com/FrankThomasTveter/metfark/farkRPackage}
"exampleData"
```
...
a Git repository (see <https://github.com/FrankThomasTveter/metfark/reproguide-curate> and
...
`farkRPackage` from GitHub user `FrankThomasTveter/metfark`. You can view this example
R package’s source code on GitHub:
<https://github.com/FrankThomasTveter/metfark/farkRPackage>.
...
For example, `farkRPackage`’s website is at
<https://github.com/FrankThomasTveter/metfark/farkRPackage>.

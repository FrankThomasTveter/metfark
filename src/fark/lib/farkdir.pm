...
our %farkdirs = ( data => {"/lustre/storeA/"   => "ro",                  # input data
		  ...
		  table      => {"/metfark/config/table/"    => "rw" },
		  table_old  => {"/metfark/config/old/table/"    => "rw" },
		  table_use  => {"/metfark/config/use/table/"    => "rw" },
		  table_fill => {"/metfark/config/fill/table/"    => "rw" },
		  table_log  => {"/metfark/config/log/table/"    => "rw" },
		  ...
		  clean     => {"/metfark/config/clean/"    => "rw" },       # clean config files
		  clean_old  => {"/metfark/config/old/clean/"    => "rw" },
		  clean_use  => {"/metfark/config/use/clean/"    => "rw" },
		  clean_fill => {"/metfark/config/fill/clean/"    => "rw" },
		  clean_log  => {"/metfark/config/log/clean/"    => "rw" },
		  ...
		  rerun_old  => {"/metfark/config/old/rerun/"    => "rw" },
		  rerun_use  => {"/metfark/config/use/rerun/"    => "rw" },
		  rerun_fill => {"/metfark/config/fill/rerun/"    => "rw" },
		  rerun_log  => {"/metfark/config/log/rerun/"    => "rw" },
		  exec       => {"/metfark/config/exec/"    => "rw" },       # execute config files
...
sub removeFile{
	...
	if (! @nodes) {@nodes=$doc->findnodes("table/table_config");};

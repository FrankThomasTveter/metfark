...
//------------------------------------------------------------------------
*/
/* 20110513-mao: commented following inclusion of fortint.h
...
void 
pbopen_(fortint* unit,_fcd name,_fcd mode,fortint* iret,fortint l1,fortint l2) {
/*#endif*/
/*
// Purpose:
 ...
 */
void 
pbopen(fortint* unit,_fcd name,_fcd mode,fortint* iret,fortint l1,fortint l2) {

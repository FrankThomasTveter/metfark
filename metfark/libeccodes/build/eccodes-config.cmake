...
set( ECCODES_SELF_INCLUDE_DIRS "/metfark/metfark/metfark/libeccodes/build;/metfark/metfark/metfark/libeccodes/build/eccodes-2.7.0-Source/src;/metfark/metfark/metfark/libeccodes/build/src;/metfark/metfark/metfark/libeccodes/build/fortran/modules" )
set( ECCODES_SELF_DEFINITIONS  "" )
set( ECCODES_SELF_LIBRARIES    "eccodes;eccodes_f90" )

set( ECCODES_TPLS              "Python;CMath" )
set( ECCODES_TPL_INCLUDE_DIRS  "" )
set( ECCODES_TPL_DEFINITIONS   "" )
set( ECCODES_TPL_LIBRARIES     "/usr/lib/x86_64-linux-gnu/libm.so" )

set( ECCODES_VERSION           "2.7.0" )
...
set( ECCODES_FEATURES    "TESTS;EXAMPLES;JPG;FORTRAN;INSTALL_ECCODES_DEFINITIONS;INSTALL_ECCODES_SAMPLES" )
...
if( NOT eccodes_BINARY_DIR )
  ...
  if( ECCODES_IS_BUILD_DIR_EXPORT )
    include( "/metfark/metfark/metfark/libeccodes/build/eccodes-targets.cmake" OPTIONAL )
  else()
...
if( NOT eccodes )
  if( ECCODES_IS_BUILD_DIR_EXPORT )
    set( eccodes_BASE_DIR /metfark/metfark/metfark/libeccodes/build )
  else()

subroutine mod_clearexpressionstack(sid, crc250, irc)
  use model
  implicit none
  integer :: sid             ! session id
  character*250 :: crc250
  integer :: irc
  character*25 :: myname = "clearExpressionStack"
  ...
  call model_clearexpressionstack(css,crc250,irc)
  if (irc.ne.0) then
     call model_errorappend(crc250,"|")
  ...
  !write(*,*) myname,' Done.'
  return
end subroutine mod_clearexpressionstack

#__file: 'plo_clearAttrStack.F90' 0100664    **DO NOT DELETE**
...
#__file: 'plo_clearSetStack.F90' 0100664    **DO NOT DELETE**
...
#__file: 'plo_closeSession.F90' 0100664    **DO NOT DELETE**
...
#__file: 'plo_makeGraphics.F90' 0100664    **DO NOT DELETE**
...
#__file: 'plo_makeTable.F90' 0100664    **DO NOT DELETE**
subroutine plo_maketable(sid,cid,mid,oid,tab250,gra250,crc250, irc)
  use plot
  use model
  use observations
  use colocation
  ...
  !
  call  plot_maketable(pss,css,mss,oss,tab250,gra250,crc250,irc)
  if (irc.ne.0) then
     call plot_errorappend(crc250,"|")
     call plot_errorappend(crc250,trim(myname))
...
#__file: 'plo_openSession.F90' 0100664    **DO NOT DELETE**
...
#__file: 'plo_pushAttr.F90' 0100664    **DO NOT DELETE**
...
#__file: 'plo_popSet.F90' 0100664    **DO NOT DELETE**
subroutine plo_popset(sid,cid,mid,oid,nam250,x250,y250,leg250,crc250, irc)
  use plot
  use model
  use observations
  use colocation
  ...
  character*250 :: crc250
  integer :: irc
  character*25 :: myname = "plo_popset"
  type(plot_session), pointer :: pss !  current session
  type(col_session), pointer ::  css !  current session
  type(mod_session), pointer ::  mss !  current session
  type(obs_session), pointer ::  oss !  current session
  ...
  !
  call  plot_popset(pss,css,mss,oss,nam250,x250,y250,leg250,crc250, irc)
  if (irc.ne.0) then
     call plot_errorappend(crc250,"|")
     call plot_errorappend(crc250,trim(myname))
     call plot_errorappend(crc250," Error return from plot_popset.")
     call plot_errorappendi(crc250,irc)
     return
  end if
  return
end subroutine plo_popset
#__file: 'plo_pushSet.F90' 0100664    **DO NOT DELETE**
subroutine plo_pushset(sid,cid,mid,oid,nam250,x250,y250,leg250,crc250, irc)
  use plot
  use model
  use observations
  use colocation
  ...
  !
  call  plot_pushset(pss,css,mss,oss,nam250,x250,y250,leg250,crc250, irc)
  if (irc.ne.0) then
     call plot_errorappend(crc250,"|")
     call plot_errorappend(crc250,trim(myname))
...
#__file: 'plo_setType.F90' 0100664    **DO NOT DELETE**
...
#__file: 'plot.F90' 0100664    **DO NOT DELETE**
module plot
  IMPLICIT NONE
  !
  ! Global constants
...
CONTAINS
  ...
  subroutine plot_removeSession(css,crc250,irc)
    ...
    !call plot_clearAttributeStack(css)
  ...
  !
  subroutine plot_popset(pss,css,mss,oss,nam250,x250,y250,leg250,crc250,irc)
    use model
    use observations
    use colocation
    implicit none
